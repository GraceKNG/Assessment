...
class Quiz:
    ...
    def questions_setup(self):
       ...
       self.rb1.config(text=quesions_answers[qnum][1])
       self.rb2.config(text=quesions_answers[qnum][2])
       self.rb3.config(text=quesions_answers[qnum][3])
       self.rb4.config(text=quesions_answers[qnum][4])

    def test_progress(self):
        global score
        scre_label = self.score_label
